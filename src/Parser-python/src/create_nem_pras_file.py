...
from generators_group import GeneratorsGroup
from generatorstorages_group import GeneratorStoragesGroup
from hourly_hydro_inflow_calculator import HourlyHydroInflowCalculator
from interfaces_lines_group import InterfacesGroup, LinesGroup
from filter_sort_timestep_data import FilterSortTimestepData
from regions_group import RegionsGroup
from storages_group import StoragesGroup
...
input_folder = os.path.join(current_working_directory, "..", "input")
output_folder = os.path.join(current_working_directory, "..", "output")
...
timestep_generator_output_file = os.path.join(output_folder, timestep_generator_output_filename)
...
generatorstorage_inflows_output_file = os.path.join(output_folder, generatorstorage_inflows_output_filename)
