...
@testset "Create System Tests" begin
    ...
    regions_selected = []
    gens, gen_region_attribution = PRASNEM.createGenerators(generator_input_file, timeseries_folder, units, regions_selected, start_dt, end_dt)
    storages, storage_region_attribution = PRASNEM.createStorages(storages_input_file, timeseries_folder, units, regions_selected, start_dt, end_dt)
